...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('contact', null, ['class' => 'form-control','maxlength' => 191,'maxlength' => 191,'maxlength' => 191]) !!}
</div>
...
{!! Form::label('categoryId', 'Categoryid:') !!}
    {!! Form::select('categoryId', $category->pluck('title', 'id'), null, ['class' => 'form-control select2']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('admin.hosts.index') }}" class="btn btn-default">Cancel</a>
</div>
